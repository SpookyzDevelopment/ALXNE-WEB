      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full">
            ...
            <span className="text-sm text-cyan-400 font-medium">Flexible Plans</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-1 text-sm font-medium rounded-full shadow-lg shadow-blue-500/25">
                  Most Popular
                </div>
              )}
              <div className="mb-6">
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start space-x-3">
                    <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full p-1 mt-0.5">
